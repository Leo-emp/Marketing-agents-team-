...
// # Accent colors — indigo/violet premium palette
export const ACCENT_1 = "#6366f1"; // # Indigo (primary brand color)
export const ACCENT_2 = "#8b5cf6"; // # Violet (gradient pair)
export const ACCENT_3 = "#a78bfa"; // # Light violet (highlights)
